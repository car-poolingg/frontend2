                ...
                <div className='RegistrationInputs'>
                    <form onSubmit={handleUserRegistration}>
                        <div className='InputFields'>
                            <label for="email" className='labelemail'>First Name</label>
                            <input className='email' type="text" id="email" name="firstname" {...inputOption} />
                        </div>
                        <div className='InputFields'>
                            <label for="email" className='labelemail'>Last Name</label>
                            <input className='email' type="text" id="email" name="lastname" {...inputOption} />
                        </div>
                        <div className='InputFields'>
                            <label for="email" className='labelemail'>Email Address</label>
                            <input className='email' type="email" id="email" name="email" {...inputOption} />
                        </div>
                        {/* <div className='InputFields'>
                <label for="email" className='labelemail'>Email Address</label>
                    <input className='email' type="email" id="email" name="email" />
                        ...
                        <div className='InputFields'>
                            <label for="email" className='labelemail'>Phone Number</label>
                            <input className='email' type="number" id="email" name="phone" {...inputOption} />
                        </div>

                        <div className='InputFields'>
                            <label for="Password" className='labelpass'>Password</label>
                            <PasswordInput value={signUpState["password"]}
                                {...inputOption} name={"password"} />
                        </div>

                        <div className='InputFields'>
                            <label for="Password" className='labelpass'>Confirm Password</label>
                            <PasswordInput value={signUpState["confirmPassword"]}
                                {...inputOption} name="confirmPassword" />
                        </div>
                        {/* <RememberMeButton/> */}
